...
// Mirrors src/app/feedback/[token]/feedback-state-card.tsx's visual
// language and the same established choice to keep each token type's
// "invalid link" copy in its own small component rather than sharing one.
export default function DealTicketStateCard({ title, body }: { title: string; body: string }) {
  return (
    <motion.div
