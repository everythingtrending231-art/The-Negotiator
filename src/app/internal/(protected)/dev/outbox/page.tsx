...
// Phase-1 QA-only infrastructure — the only way to retrieve a "sent"
// magic link in this sandbox (no real inbox available). Exposes raw
// magic-link URLs to anyone who clears the internal password gate; must
// be removed or hardened before a real production deploy.
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link href="/internal/cases" className="text-sm underline text-slate-500">
          Back to cases
        </Link>
      </div>
